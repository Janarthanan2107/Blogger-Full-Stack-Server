...
1. **Clone the repository:**
   ...
   ```bash
   https://github.com/Janarthanan2107/Blogger-Full-Stack-Client.git
   ```
...
4. Your React application should now be running locally on [http://localhost:5173/](http://localhost:5000/).
